...
while(True):
    a = readBarcode("/dev/input/event0") 
    print(type(a))
    
    if a == '8801116007172':
        print("check")
        data_1 = {"name":"hong","price":40000}
        db.child("MainData","MainData_3").set(data_1)
        

    if a == '88021331':
        print("check")
        data_2 = {"name":"hong2","price":5000}
        db.child("MainData","MainData_4").set(data_2)
